...
`},52152:(e,t,r)=>{r.d(t,{S2:()=>p,UK:()=>f});var a=r(95155),i=r(15383),o=r(47211),n=r(12115),d=r(56788),l=r(16771),s=r(87358);let c=n.createContext({}),u=/^[a-zA-Z0-9-]+\.apps\.googleusercontent\.com$/,p=({children:e})=>{let{mode:t,isSingleVendor:r}=(0,d.q)(),n=(0,d.LT)(t),p=(0,o.IT)(i.uD,{context:r?{appMode:d.Pg.MULTI}:void 0}),f=(0,o.IT)(l.Hp,{skip:!r}),v=p.loading||p.error||!p.data?.configuration?{currency:"",currencySymbol:"",deliveryRate:0,costType:"perKM"}:p.data.configuration,m=r&&f.data?.configuration||v,g=s.env.NEXT_PUBLIC_GOOGLE_WEB_CLIENT_ID??v.webClientID,y=u.test(g??"")?g:"not_found",b=m.publishableKey,h=v.clientId,_=s.env.NEXT_PUBLIC_GOOGLE_MAPS_API_KEY??"",I=v.webAmplitudeApiKey,C={GOOGLE:v.googleColor},x=v.webSentryUrl,A=m.currency||"XOF",k=m.currencySymbol||"FCFA",w=m.deliveryRate,S=m.costType,T=v.testOtp,E=v?.firebaseKey,P=v?.projectId,U=v?.storageBucket,O=v?.msgSenderId,$=v?.appId,F=v?.measurementId,q=v?.vapidKey,M=v?.authDomain,N=n.restUrl;return(0,a.jsx)(c.Provider,{value:{GOOGLE_CLIENT_ID:y,STRIPE_PUBLIC_KEY:b,PAYPAL_KEY:h,GOOGLE_MAPS_KEY:_,AMPLITUDE_API_KEY:I,LIBRARIES:"places,drawing,geometry".split(","),COLORS:C,SENTRY_DSN:x,SKIP_EMAIL_VERIFICATION:!0,SKIP_MOBILE_VERIFICATION:!0,CURRENCY:A,CURRENCY_SYMBOL:k,DELIVERY_RATE:w,COST_TYPE:S,TEST_OTP:T,SERVER_URL:N,FIREBASE_KEY:E,FIREBASE_APP_ID:$,FIREBASE_VAPID_KEY:q,FIREBASE_MEASUREMENT_ID:F,FIREBASE_MSG_SENDER_ID:O,FIREBASE_PROJECT_ID:P,FIREBASE_STORAGE_BUCKET:U,FIREBASE_AUTH_DOMAIN:M},children:e})};c.Consumer;let f=()=>(0,n.useContext)(c)},70408:(e,t,r)=>{function a(e=[]){return e.map(e=>({_id:e._id,options:e.options.map(e=>e._id)}))}function i(e=[]){return e.flatMap(e=>e.options.map(t=>`${e._id}:${t._id}`)).sort().join("|")}function o(e,t,r,a=[]){return e._id===t&&e.variation._id===r&&i(e.addons)===i(a)}function n(e){if(null==e||""===e)return null;let t=Number(e);return Number.isFinite(t)?Math.max(t,0):null}function d(e){let t=n(e.quantity)??0,r=n(e.actualUnitPrice)??n(e.unitPrice)??0,a=n(e.discountedUnitPrice)??r,i=n(e.actualItemTotal),o=n(e.discountedItemTotal)??n(e.itemTotal);return{actualUnitPrice:t>0&&null!==i?i/t:r,discountedUnitPrice:t>0&&null!==o?o/t:a}}r.d(t,{$F:()=>o,HG:()=>d,wm:()=>a})},88904:(e,t,r)=>{r.d(t,{Ay:()=>I,vu:()=>_});var a=r(95155),i=r(18761),o=r(35036),n=r(51996),d=r(16763),l=r(99807),s=r(34080),c=r(43597),u=r(12115),p=r(98825),f=r(68715),v=r(56788),m=r(70408),g=r(16771);let y=(0,d.J1)`
  ${n.vC}
`,b=(0,d.J1)`
  ${o.E4}
`,h=(0,u.createContext)({}),_=e=>{let{isSingleVendor:t}=(0,v.q)(),[r,o]=(0,u.useState)(!0),n=(0,l.m)(),[d,_]=(0,u.useState)((0,f.iD)()),[I,C]=(0,u.useState)([]),[x,A]=(0,u.useState)(null),[k]=(0,s.n)(b,{onError:W}),w=(0,u.useCallback)(e=>(e?.foods??[]).flatMap(e=>(e.variations??[]).map(t=>{let r=(0,m.HG)(t);return{key:t._id||`${e.foodId}-${t.variationId}`,_id:e.foodId,image:e.foodImage||"",quantity:Number(t.quantity)||0,variation:{_id:t.variationId},title:e.foodTitle,foodTitle:e.foodTitle,variationTitle:t.variationTitle,price:r.discountedUnitPrice,actualUnitPrice:r.actualUnitPrice,discountedUnitPrice:r.discountedUnitPrice,dealInfo:t.dealInfo,categoryId:e.categoryId,optionTitles:(t.addons??[]).map(e=>e.title).filter(Boolean),addons:(t.addons??[]).map(e=>({_id:e.addonId,options:[{_id:e.optionId,title:e.title}]}))}})),[]),[S]=(0,c._)(g.dV,{fetchPolicy:"network-only",onCompleted:e=>C(w(e?.getUserCart))}),[T]=(0,s.n)(g.$_,{onCompleted:e=>C(w(e?.userCartData))}),[E]=(0,s.n)(g.lb),[P]=(0,s.n)(g.f1),[U,{called:O,loading:$,error:F,data:q}]=(0,c._)(t?g.yZ:i.p6,{fetchPolicy:"cache-and-network",onCompleted:function(e){e.profile&&ed()},onError:W}),[M,{called:N,loading:D,error:L,data:j,networkStatus:B,fetchMore:R,subscribeToMore:z}]=(0,c._)(t?g.pU:i.gf,{variables:{page:1,limit:300},fetchPolicy:"cache-and-network",onError:W}),J=(0,u.useCallback)((e,t)=>{if(!t||!e.length)return e;let r=t.categories?t.categories.flatMap(e=>e.foods):[],{addons:a,options:i}=t;return r.length&&a&&i?e.map(e=>{let t=r.find(t=>t._id===e._id);if(!t)return e;let o=t.variations.find(t=>t._id===e.variation._id);if(!o)return e;let n=t.title,d=o.title,l=`${n}(${d})`,s=o.price,c=[];return e.addons&&e.addons.length>0&&e.addons.forEach(e=>{a.find(t=>t._id===e._id)&&e.options.forEach(e=>{let t=i.find(t=>t._id===e._id);t&&(s+=t.price,t.title&&c.push(t.title))})}),{...e,foodTitle:n,variationTitle:d,title:l,optionTitles:c,price:s.toFixed(2)}}):e},[]),G=(0,u.useCallback)(async e=>{if(!e)return;o(!0);let r=(0,f.iD)()||null;_(r),r&&(await U(),await M(),t&&await S()),o(!1)},[U,M,S,t]),K=(0,u.useCallback)(async e=>{A(e),v.vi.set("restaurant",e)},[]);function W(e){console.log("error",e.message)}(0,u.useEffect)(()=>{{let e=v.vi.get("restaurant"),t=v.vi.get("cartItems");if(e&&A(e),t)try{C(JSON.parse(t))}catch(e){console.error("Error parsing cart items from localStorage:",e),C([])}}o(!1)},[]),(0,u.useEffect)(()=>(G(!0),()=>{}),[d,G]);let V=(0,u.useCallback)(async(e,t=()=>{})=>{_(e),v.vi.set("token",e),t()},[]),H=(0,u.useCallback)(async()=>{try{(0,f.Lr)(),C([]),A(null),_(null),await n.resetStore()}catch(e){console.log("error on logout",e)}},[n]),Q=(0,u.useCallback)(()=>{if(z&&q?.profile?._id)try{let e=z({document:t?g.Wf:y,variables:{userId:q.profile._id},updateQuery:(e,{subscriptionData:r})=>{if(!r.data)return e;let a=t?r.data.orderStatusChanged.rawOrder:r.data.orderStatusChanged.order,{_id:i}=a;if(t){let t=e?.getUsersActiveOrders??[],r=0>t.findIndex(e=>e._id===i)?[a,...t]:t.map(e=>e._id===i?{...e,...a}:e);return{...e,getUsersActiveOrders:r}}if("new"===r.data.orderStatusChanged.origin)return(e?.orders||[])?.findIndex(e=>e._id===i)>-1?e:{orders:[r.data.orderStatusChanged.order,...e.orders||[]]};{let{orders:t}=e,a=[...t||[]],o=a.findIndex(e=>e._id===i);if(o>-1){let e=r.data.orderStatusChanged.order;a[o]={...a[o],...e,restaurant:{...a[o].restaurant,...e.restaurant}}}return{orders:[...a]}}}});n.onResetStore(()=>(e(),Promise.resolve()))}catch(e){console.log("error subscribing order",e.message)}},[n,q,t,z]);(0,u.useEffect)(()=>{q&&Q()},[q,Q]);let X=(0,u.useCallback)(()=>{if(7===B&&R){if(t)return void R({variables:{page:Math.floor((j?.getUsersActiveOrders?.length??0)/20)+1,limit:20},updateQuery:(e,{fetchMoreResult:t})=>({...e,getUsersActiveOrders:[...e.getUsersActiveOrders??[],...t?.getUsersActiveOrders??[]]})});R({variables:{offset:j?.orders?.length+1||0},updateQuery:(e,{fetchMoreResult:t})=>t&&0!==t.orders.length?{orders:e.orders.concat(t.orders)}:e})}},[j,R,t,B]),Z=(0,u.useCallback)(()=>{C([]),A(null),v.vi.remove("cartItems"),v.vi.remove("restaurant"),t&&P()},[P,t]),Y=(0,u.useCallback)(async(e,t=1)=>{C(r=>{let a=[...r],i=a.findIndex(t=>t.key===e);return -1!==i&&(a[i].quantity=a[i].quantity+t,v.vi.set("cartItems",JSON.stringify(a))),a})},[]),ee=(0,u.useCallback)(async e=>{C(t=>{let r=[...t],a=r.findIndex(t=>t.key===e);if(a>-1){r.splice(a,1);let e=r.filter(e=>e.quantity>0);return 0===e.length?(v.vi.remove("cartItems"),v.vi.remove("restaurant"),A(null)):v.vi.set("cartItems",JSON.stringify(e)),e}return r})},[]),et=(0,u.useCallback)(async e=>{C(t=>{let r=[...t],a=r.findIndex(t=>t.key===e);if(-1===a)return t;r[a].quantity=r[a].quantity-1;let i=r.filter(e=>e.quantity>0);return 0===i.length?(v.vi.remove("cartItems"),v.vi.remove("restaurant"),A(null)):v.vi.set("cartItems",JSON.stringify(i)),i})},[]),er=(0,u.useCallback)(e=>{let t=I.findIndex(t=>t._id===e);return t<0?{exist:!1,quantity:0}:{exist:!0,quantity:I[t].quantity,key:I[t].key}},[I]),ea=(0,u.useCallback)(()=>I.map(e=>e.quantity).reduce((e,t)=>e+t,0),[I]),ei=(0,u.useCallback)(async(e,r,a,i,o=1,n=[],d="")=>{if(t)return void T({variables:{input:{food:[{_id:r,categoryId:i||"",variation:{_id:a,addons:(0,m.wm)(n),count:o}}]}}});let l=!!(i&&x!==i),s={image:e,key:(0,p.A)(),_id:r,quantity:o,variation:{_id:a},addons:n,specialInstructions:d};await K(i),C(e=>{let t=[...l?[]:[...e],s];return v.vi.set("cartItems",JSON.stringify(t)),t})},[t,x,K,T]),eo=(0,u.useCallback)(async e=>{if(!t)return;let r=Math.max(0,Math.floor(e.quantity)),a=I.find(t=>(0,m.$F)(t,e.foodId,e.variationId,e.addons));C(t=>{let a=t.findIndex(t=>(0,m.$F)(t,e.foodId,e.variationId,e.addons));return 0===r?t.filter((e,t)=>t!==a):a>=0?t.map((e,t)=>t===a?{...e,quantity:r}:e):[...t,{key:`optimistic:${e.foodId}:${e.variationId}`,_id:e.foodId,variation:{_id:e.variationId},quantity:r,categoryId:e.categoryId,image:e.image??"",title:e.foodTitle,foodTitle:e.foodTitle,variationTitle:e.variationTitle,price:e.unitPrice,addons:e.addons??[]}]});try{if(a&&!a.key.startsWith("optimistic:")){let t=await E({variables:{input:{variation_id:a.key,foodId:e.foodId,categoryId:e.categoryId||a.categoryId,variationId:e.variationId,action:0===r?"delete":r>a.quantity?"increase":"decrease",count:r}}});if(!t.data?.updateUserCartCount?.success)throw Error(t.data?.updateUserCartCount?.message||"Unable to update cart")}else if(r>0){let t=await T({variables:{input:{food:[{_id:e.foodId,categoryId:e.categoryId,variation:{_id:e.variationId,addons:(0,m.wm)(e.addons),count:r}}]}}});if(!t.data?.userCartData?.success)throw Error(t.data?.userCartData?.message||"Unable to update cart")}}catch(e){throw await S(),e}},[I,S,t,T,E]),en=(0,u.useCallback)(async e=>{JSON.stringify(I)!==JSON.stringify(e)&&(C(e),v.vi.set("cartItems",JSON.stringify(e)))},[I]),ed=(0,u.useCallback)(()=>{{let e=v.vi.get("messaging-token");e&&k({variables:{token:e}})}},[k]),el=(0,u.useCallback)(async(e,r)=>{let a=r>0?1:-1;if(t){let t=I.find(t=>t.key===e);if(!t?.categoryId)return;try{await eo({foodId:t._id,categoryId:t.categoryId,variationId:t.variation._id,quantity:Math.max(0,t.quantity+a),image:t.image,foodTitle:t.foodTitle||t.title,variationTitle:t.variationTitle,unitPrice:Number(t.price)||0,addons:t.addons})}catch(e){console.error("Unable to update Single Vendor cart item",e)}return}let i=!1;C(t=>{if(i)return t;let r=[...t],o=r.findIndex(t=>t.key===e);if(-1===o)return t;let n=r[o],d=n.quantity;return console.log(`[UserContext] Current quantity for ${e}: ${d}`),a<0&&d<=1?r.splice(o,1):r[o]={...n,quantity:d+a},i=!0,0===r.length?(v.vi.remove("cartItems"),v.vi.remove("restaurant"),A(null)):v.vi.set("cartItems",JSON.stringify(r)),r})},[I,t,eo]),es=(0,u.useCallback)(async e=>{await ee(e)},[ee]),ec=(0,u.useCallback)(()=>I.reduce((e,t)=>{let r=t.variation?.price??t.price??0;return e+("string"==typeof r?parseFloat(r):r)*(t.quantity??0)},0).toFixed(2),[I]),eu=(0,u.useMemo)(()=>({isLoggedIn:!!d,loadingProfile:$&&O,errorProfile:F,profile:q&&q.profile?q.profile:null,fetchProfile:U,setTokenAsync:V,logout:H,loadingOrders:D&&N,errorOrders:L,orders:t?j?.getUsersActiveOrders??[]:j?.orders??[],fetchOrders:M,fetchMoreOrdersFunc:X,networkStatusOrders:B,cart:I,cartCount:ea(),clearCart:Z,updateCart:en,addQuantity:Y,removeQuantity:et,addItem:ei,checkItemCart:er,deleteItem:ee,restaurant:x,setCartRestaurant:K,isLoading:r,updateItemQuantity:el,removeItem:es,calculateSubtotal:ec,transformCartWithFoodInfo:J,setCart:C,setSingleVendorItemQuantity:eo}),[d,$,O,F,q,U,V,H,D,N,L,j,M,X,B,I,ea,Z,en,Y,et,ei,er,ee,x,K,r,el,es,ec,J,C,eo]);return(0,a.jsx)(h.Provider,{value:eu,children:e.children})};h.Consumer;let I=h}}]);