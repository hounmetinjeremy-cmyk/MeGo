...
`,$=(0,r.J1)`mutation SaveNotificationTokenWeb($token:String!){
    saveNotificationTokenWeb(token:$token){
      success
      message
    }
  }`,A=(0,r.J1)` mutation updateNotificationStatus($orderNotification: Boolean!, $offerNotification: Boolean! ) {
