...
} from "@/lib/store/utils/interfaces/rider-earnings.interface";

// Charts
import { barDataItem } from "react-native-gifted-charts";

// GraphQL
import { STORE_EARNINGS_GRAPH } from "@/lib/store/apollo/queries/earnings.query";
...
// Skeletons
import { EarningScreenMainLoading } from "@/lib/store/ui/skeletons";

// Components
import { useApptheme } from "@/lib/store/context/theme.context";
import { formatAmount } from "@/lib/store/utils/methods";
            ...
            <View className="flex-row justify-between items-center mb-3">
              ...
              <TouchableOpacity
                onPress={() => {
                  ...
                  router.push(
                    "/store/(tabs)/earnings/(routes)/earnings-detail",
                  );
                }}
              >
                <Text
