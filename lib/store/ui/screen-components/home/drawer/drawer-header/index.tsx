import { UPDATE_AVAILABILITY } from "@/lib/store/apollo/mutations/store.mutation";
...
import CustomSwitch from "@/lib/store/ui/useable-components/switch-button";
import { IStoreProfile } from "@/lib/store/utils/interfaces";
