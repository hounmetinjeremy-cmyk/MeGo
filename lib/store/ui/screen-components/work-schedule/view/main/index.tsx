import { UPDATE_WORK_SCHEDULE } from "@/lib/store/apollo/mutations/work-schedule";
import { useUserContext } from "@/lib/store/context/global/user.context";

import { WorkSchedule } from "@/lib/store/utils/interfaces";
import { useMutation } from "@apollo/client";

import { STORE_PROFILE } from "@/lib/store/apollo/queries";
import { useApptheme } from "@/lib/store/context/theme.context";
import { timeToMinutes } from "@/lib/store/utils/methods/helpers/work-schedule";
import { TWeekDays } from "@/lib/store/utils/types/restaurant";
