...
// Schemas
import { SignInSchema } from "@/lib/store/utils/schema";
// Hook
import useLogin from "@/lib/store/hooks/useLogin";
// Interface
import { useApptheme } from "@/lib/store/context/theme.context";
import { ILoginInitialValues } from "@/lib/store/utils/interfaces";
...
import { STORE_SERVER_MODES, StoreServerMode } from "@/lib/store/mode/store-mode";
                ...
                <View className="flex-1 items-center">
                  ...
                  <View className="flex-1 w-full p-5 items-center justify-center gap-y-2">
                    <Image
                      ...
                      source={require("@/lib/store/assets/images/icon.png")}
                      resizeMode="contain"
                      style={{
                        width: 128,
                        height: 128,
