...
// Schemas
import { SignInSchema } from "@/lib/rider/utils/schema";
import { useTranslation } from "react-i18next";

// Hooks
import useLogin from "@/lib/rider/hooks/useLogin";

// Interface
import { useApolloClient } from "@apollo/client";
import { useApptheme } from "@/lib/rider/context/global/theme.context";
import { ILoginInitialValues } from "@/lib/rider/utils/interfaces";
import { CustomContinueButton } from "../../useable-components";
import { useRiderMode } from "@/lib/rider/context/global/rider-mode.context";
import { RIDER_SERVER_MODES, RiderServerMode } from "@/lib/rider/mode/rider-mode";
                ...
                <View className="flex-1 items-center">
                  ...
                  <View className="flex-1 w-full p-5 items-center justify-center gap-y-2">
                    <Image
                      ...
                      source={require("@/lib/rider/assets/images/icon.png")}
                      resizeMode="contain"
                      style={{
                        width: 128,
                        height: 128,
