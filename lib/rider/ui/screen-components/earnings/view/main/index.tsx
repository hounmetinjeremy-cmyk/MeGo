...
// GraphQL
import { RIDER_EARNINGS_GRAPH } from "@/lib/rider/apollo/queries/earnings.query";
...
// Skeletons
import { EarningScreenMainLoading } from "@/lib/rider/ui/skeletons";
...
// Helpers
import formatNumber from "@/lib/rider/utils/methods/num-formatter";
      ...
      <View className="flex flex-row justify-between w-full px-4 py-4">
        ...
        <TouchableOpacity
          onPress={() => {
            ...
            router.push("/rider/(tabs)/earnings/(routes)/earnings-detail");
          }}
        >
