...
import { EDIT_RIDER } from "@/lib/rider/apollo/mutations/rider.mutation";
import { RIDER_PROFILE } from "@/lib/rider/apollo/queries";
...
import { FlashMessageComponent } from "@/lib/rider/ui/useable-components";
...
import {
  ...
  MotorBikeIcon,
  TruckIcon,
} from "@/lib/rider/ui/useable-components/svg";
import { VEHICLE_TYPE } from "@/lib/rider/utils/constants";
import { IVehicleTypeItem } from "@/lib/rider/utils/interfaces";
