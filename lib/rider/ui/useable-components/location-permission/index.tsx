import { useLocationContext } from "@/lib/rider/context/global/location.context";
import { useApptheme } from "@/lib/rider/context/global/theme.context";
import { ILocationPermissionComponentProps } from "@/lib/rider/utils/interfaces";
        ...
        <View className="h-fit w-full bg-transparent justify-around items-center">
          ...
          >
            <View className="gap-y-2">
              ...
              >
                {t(
                  "MeGo uses your precise location while you use the app to show your current position and support pickup and delivery navigation.",
                )}
              </Text>
            </View>
      ...
      >
        <View className="w-full items-center">
          ...
          >
            ...
            >
              {t(
                "MeGo collects and transmits your precise location to the delivery server to enable live delivery tracking for customers and dispatchers during an active delivery, even when the app is not in use. Location sharing starts only after you accept a delivery and stops when the delivery ends or you log out.",
              )}
            </Text>
