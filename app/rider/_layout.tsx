...
// Service
import setupApollo from "@/lib/rider/apollo";
import { initSentry } from "@/lib/rider/utils/service";

// Providers
import { AuthProvider } from "@/lib/rider/context/global/auth.context";
import { ConfigurationProvider } from "@/lib/rider/context/global/configuration.context";
import { LocationProvider } from "@/lib/rider/context/global/location.context";
import { SoundProvider } from "@/lib/rider/context/global/sound.context";
import { UserProvider } from "@/lib/rider/context/global/user.context";
import { ChatNotificationProvider } from "@/lib/rider/context/global/chat-notification.context";
...
// Style
import InternetProvider from "@/lib/rider/context/global/internet-provider";
import AppThemeProvidor from "@/lib/rider/context/global/theme.context";
import RootStackLayout from "@/lib/rider/ui/layouts/root-layout";
import { LocationPermissionComp } from "@/lib/rider/ui/useable-components";
import AnimatedSplashScreen from "@/lib/rider/ui/useable-components/splash/AnimatedSplashScreen";
...
import {
  RiderModeProvider,
  useRiderMode,
} from "@/lib/rider/context/global/rider-mode.context";
...
function RootLayout() {
  const [loaded] = useFonts({
    Inter: require("../../lib/rider/assets/fonts/Inter.ttf"),
  });
